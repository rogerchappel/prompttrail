...
Replace this section with the supported versions for `prompttrail`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `prompttrail` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in prompttrail.
