...
const HELP = [
  ...
  '  prompttrail list [--format markdown|json] [--type <type>] [--limit <n>] [--since <iso-instant>] [--until <iso-instant>] [--dir <path>]',
  '    Time bounds are inclusive ISO-8601 instants with a timezone (for example, 2026-05-17T00:00:00Z).',
